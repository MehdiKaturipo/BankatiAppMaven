...
import ma.Bankati.dao.daoVolatile.CréditDao;
import ma.Bankati.modéle.Crédit;
import ma.Bankati.métier.IMétierCrédit;
import ma.Bankati.métier.MétierCrédit;
import ma.Bankati.présentation.CreditControlleur;
import ma.Bankati.présentation.ICréditControlleur;
...
public class SimulateurDeCrédit_App {
    ...
    public  static void test2() throws Exception {
        ...
        InputStream config = classLoader.getResourceAsStream("config/config.properties");
    ...
    public  static void test3() throws Exception{
        ApplicationContext context = new ClassPathXmlApplicationContext("config/spring-ioc.xml");
        créditControlleur = context.getBean(ICréditControlleur.class);
        créditControlleur.afficherMensualité(3L);
    }
    public  static void test4() throws Exception{
        ApplicationContext context = new AnnotationConfigApplicationContext("ma.Bankati");
